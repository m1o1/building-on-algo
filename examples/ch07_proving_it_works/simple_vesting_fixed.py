...
class SimpleVesting(ARC4Contract):
    ...
    The same contract, with the three defects repaired: the schedule
    computes through a 128-bit intermediate instead of overflowing at
    scale, a claim that would move nothing rejects instead of
    succeeding quietly, and every rejection carries a message.
    """
