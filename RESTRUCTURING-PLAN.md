...
**Still outstanding in 5a:** Chapters 2, 4, 5, 6, and 7, and the closing edit to the project chapter that ends Part I. The phase is not done, and the honest read on pace is that the review-and-correct cycle dominates, exactly as the Phase 4 note predicted.
