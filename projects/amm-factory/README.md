...
This project is the finished example for Chapter 16 of *Building on Algorand*.
It extends the Chapter 14 AMM with an on-chain factory that creates pools,
...
The project is self-contained. It reuses the Chapter 14 AMM ideas, but it does
not import Chapter 14 generated clients or artifacts.
