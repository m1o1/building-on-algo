...
def main() -> int:
    ...
    # A previous run's 366-day jump would otherwise still be in force, one
    # year per block. Park the clock at one second a block first.
    normalize_localnet_time(algorand)
    ...
    farm, farm_create = farm_factory.send.create.create()
    ...
    print("Chapter 17 LP farming workflow complete.")
    return 0
