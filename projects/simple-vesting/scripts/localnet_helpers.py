...
def create_test_asa(
    ...
    result = algorand.send.asset_create(
        algokit_utils.AssetCreateParams(
            ...
            asset_name="Chapter8 Test Token",
            unit_name="C8T",
            note=random_note(),
        )
    )
...
def produce_block(algorand: algokit_utils.AlgorandClient) -> None:
...
def timestamp_offset(algorand: algokit_utils.AlgorandClient) -> int:
...
def latest_timestamp(algorand: algokit_utils.AlgorandClient) -> int:
