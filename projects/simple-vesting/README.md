# Chapter 8: Simple Vesting

This is the completed Chapter 8 integration-test project from *Building on Algorand*. It intentionally preserves the simplified `SimpleVesting` contract from the chapter: one beneficiary, global-state storage, plain `UInt64` vesting math, and no revoke method.
...
- `smart_contracts/simple_vesting/contract.py` contains the Chapter 8 contract.
